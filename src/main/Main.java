...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("##############################################################################");
		PersistenciaDAO PAluno = new PersistenciaXMLDAO();
		GeraPersistenciaBO P1 = new GeraPersistenciaBO(PAluno);		
		System.out.println(P1.GPersistencia(alunos));
		System.out.println(P1.RPersistencia());
		
		System.out.println("##############################################################################");
		PAluno = new PersistenciaJSONDAO();
		P1 = new GeraPersistenciaBO(PAluno);		
		System.out.println(P1.GPersistencia(alunos));
		System.out.println(P1.RPersistencia());
		
		System.out.println("##############################################################################");
		PAluno = new PersistenciaCSVDAO();
		P1 = new GeraPersistenciaBO(PAluno);		
		System.out.println(P1.GPersistencia(alunos));
		System.out.println(P1.RPersistencia());
